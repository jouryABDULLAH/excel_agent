...
- You cannot inspect or describe a cell's existing formatting. What comes back
  is what a cell holds and what it displays, not its colour, weight or borders.
  You can set formatting directly, and you can copy an existing format from
  one range to another without knowing what that format is. Never claim what
  colour, weight or other formatting a cell already has unless the user told
  you.
