...
Three jobs: point the tools at a workbook the test owns, keep backups out of
the project, and prove the real workbook was never touched.
"""
...
from excel_agent import config, workbook
